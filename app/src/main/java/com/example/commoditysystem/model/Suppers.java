...
public class Suppers {
    ...
    public Suppers(int avatar, String suppers_name, String suppers_phone, String suppers_address, String the_last_time, String create_date) {
        this.avatar = avatar;
        this.suppers_name = suppers_name;
        this.suppers_phone = suppers_phone;
        this.suppers_address = suppers_address;
